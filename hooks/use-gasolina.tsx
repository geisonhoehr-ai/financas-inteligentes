...
export function useGasolina() {
  ...
  const { data: abastecimentos = [], isLoading, error } = useQuery<Gasolina[]>({
    ...
    queryFn: async () => {
      ...
      return (data as unknown as Gasolina[]) || []
    },
  })
  ...
  return {
    ...
    isLoading,
    error,
    createGasolina: createGasolina.mutateAsync,
    updateGasolina: updateGasolina.mutateAsync,
    deleteGasolina: deleteGasolina.mutateAsync,
