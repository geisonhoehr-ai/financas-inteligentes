...
export function useMesada() {
  ...
  return {
    ...
    createFilho: createFilho.mutateAsync,
    createMesada: createMesada.mutateAsync,
    updateMesada: updateMesada.mutateAsync,
    aplicarAjuste: aplicarAjuste.mutateAsync,
    createTarefa: createTarefa.mutateAsync,
    pagarMesada: pagarMesada.mutateAsync,
